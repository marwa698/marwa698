...
[![Email](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:marweyosry@gmail.com)
...
- Solved class imbalance with custom weighted loss function
- Built interactive **Streamlit demo app**
- `AraBERT` `HuggingFace` `PyTorch` `NLP` `Transformers`
...
- `scikit-learn` `XGBoost` `Healthcare AI`
...
- `Deep Learning` `Audio Processing` `TensorFlow`
...
![Marwa's GitHub stats](https://github-readme-stats.vercel.app/api?username=marwa698&show_icons=true&theme=tokyonight&hide_border=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=marwa698&layout=compact&theme=tokyonight&hide_border=true)
